...
int pqcrystals_kyber512_ref_keypair_derand(bit8_t *pk, bit8_t *sk, const bit8_t *coins);
int pqcrystals_kyber512_ref_keypair(bit8_t *pk, bit8_t *sk);
int pqcrystals_kyber512_ref_enc_derand(bit8_t *ct, bit8_t *ss, const bit8_t *pk, const bit8_t *coins);
int pqcrystals_kyber512_ref_enc(bit8_t *ct, bit8_t *ss, const bit8_t *pk);
int pqcrystals_kyber512_ref_dec(bit8_t *ss, const bit8_t *ct, const bit8_t *sk);
...
int pqcrystals_kyber768_ref_keypair_derand(bit8_t *pk, bit8_t *sk, const bit8_t *coins);
int pqcrystals_kyber768_ref_keypair(bit8_t *pk, bit8_t *sk);
int pqcrystals_kyber768_ref_enc_derand(bit8_t *ct, bit8_t *ss, const bit8_t *pk, const bit8_t *coins);
int pqcrystals_kyber768_ref_enc(bit8_t *ct, bit8_t *ss, const bit8_t *pk);
int pqcrystals_kyber768_ref_dec(bit8_t *ss, const bit8_t *ct, const bit8_t *sk);
...
int pqcrystals_kyber1024_ref_keypair_derand(bit8_t *pk, bit8_t *sk, const bit8_t *coins);
int pqcrystals_kyber1024_ref_keypair(bit8_t *pk, bit8_t *sk);
int pqcrystals_kyber1024_ref_enc_derand(bit8_t *ct, bit8_t *ss, const bit8_t *pk, const bit8_t *coins);
int pqcrystals_kyber1024_ref_enc(bit8_t *ct, bit8_t *ss, const bit8_t *pk);
int pqcrystals_kyber1024_ref_dec(bit8_t *ss, const bit8_t *ct, const bit8_t *sk);
