...
void polyvec_decompress(polyvec *r,
  ...
  for (i = 0; i < KYBER_K; i++) {
    for (j = 0; j < KYBER_N / 8; j++) {
      t[0] = (a[0] >> 0) | ((bit16_t)a[1] << 8);
      t[1] = (a[1] >> 3) | ((bit16_t)a[2] << 5);
      t[2] = (a[2] >> 6) | ((bit16_t)a[3] << 2) | ((bit16_t)a[4] << 10);
      t[3] = (a[4] >> 1) | ((bit16_t)a[5] << 7);
      t[4] = (a[5] >> 4) | ((bit16_t)a[6] << 4);
      t[5] = (a[6] >> 7) | ((bit16_t)a[7] << 1) | ((bit16_t)a[8] << 9);
      t[6] = (a[8] >> 2) | ((bit16_t)a[9] << 6);
      t[7] = (a[9] >> 5) | ((bit16_t)a[10] << 3);
      a += 11;
  ...
  for (i = 0; i < KYBER_K; i++) {
    for (j = 0; j < KYBER_N / 4; j++) {
      t[0] = (a[0] >> 0) | ((bit16_t)a[1] << 8);
      t[1] = (a[1] >> 2) | ((bit16_t)a[2] << 6);
      t[2] = (a[2] >> 4) | ((bit16_t)a[3] << 4);
      t[3] = (a[3] >> 6) | ((bit16_t)a[4] << 2);
      a += 5;
