...
void shake128_absorb(keccak_state *state, const uint8_t *in, bit32_t inlen);
...
void shake128_squeeze(uint8_t *out, bit32_t outlen, keccak_state *state);
...
void shake128_squeezeblocks(uint8_t *out, bit32_t nblocks, keccak_state *state);

#define shake256_init FIPS202_NAMESPACE(shake256_init)
void shake256_init(keccak_state *state);
#define shake256_absorb FIPS202_NAMESPACE(shake256_absorb)
void shake256_absorb(keccak_state *state, const uint8_t *in, bit32_t inlen);
...
void shake256_squeeze(uint8_t *out, bit32_t outlen, keccak_state *state);
...
void shake256_squeezeblocks(uint8_t *out, bit32_t nblocks, keccak_state *state);

#define shake128 FIPS202_NAMESPACE(shake128)
void shake128(uint8_t *out, bit32_t outlen, const uint8_t *in, bit32_t inlen);
#define shake256 FIPS202_NAMESPACE(shake256)
void shake256(uint8_t *out, bit32_t outlen, const uint8_t *in, bit32_t inlen);
#define sha3_256 FIPS202_NAMESPACE(sha3_256)
void sha3_256(uint8_t h[32], const uint8_t *in, bit32_t inlen);
#define sha3_512 FIPS202_NAMESPACE(sha3_512)
void sha3_512(uint8_t h[64], const uint8_t *in, bit32_t inlen);
